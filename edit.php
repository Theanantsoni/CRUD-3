...
<?php
  ...
  {
    $sql = "SELECT * FROM movie WHERE u_id=" .$_GET['edit_id'];
  ...
  if(isset($_POST['btnupdate']))
  {
    ...
    $update = "UPDATE movie SET u_fname='$userfname', u_lname='$userlname', u_email='$useremail' , u_pass='$userpass', u_conpass='$userconpass', u_mobile='$usermobile', u_address='$useraddress' WHERE u_id= ".$_GET['edit_id'];
